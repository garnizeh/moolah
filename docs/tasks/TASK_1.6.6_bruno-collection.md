...
- [ ] Initialize Bruno collection in `docs/bruno/`.
- [ ] Define environment variables (Base URL, Auth Token).
- [ ] Create requests for implemented endpoints:
  - Auth: Request OTP, Verify OTP, Refresh Token.
  - Health: Check status.
- [ ] Document how to use the collection in `README.md`.

---

## 5. Acceptance Criteria

- [ ] Bruno collection files exist in `docs/bruno/`.
- [ ] Requests are functional and use environment-based variables.
- [ ] Collection is properly structured by domain (Auth, Accounts, etc.).
