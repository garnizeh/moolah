...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/admin/tenants/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Confirmation token (must match ID)",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateTenantPlanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/assets": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by asset type (stock, bond, fund, crypto, real_estate, income_source)",
                        "name": "asset_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by currency (e.g., USD, BRL)",
                        "name": "currency",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateAssetInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/auth/otp/request": {
            "post": {
                ...
                "responses": {
                    "202": {
                        "description": "OTP requested successfully (Accepted)"
                    },
                    "400": {
                        "description": "Invalid request body",
                        "schema": {
        ...
        "/v1/categories": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Parent category ULID",
                        "name": "parent_id",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.TenantAssetConfig"
                            }
                        }
                    },
                    "401": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpsertTenantAssetConfigInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.InviteUserRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "domain.Account": {
            ...
            "properties": {
                "balance_cents": {
                    "description": "Always in cents; never float",
                    "type": "integer"
                },
                "created_at": {
                    "type": "string"
        ...
        "domain.Category": {
            ...
            "properties": {
                ...
                "parent_id": {
                    "description": "Empty string means root category",
                    "type": "string"
                },
                "tenant_id": {
                    "type": "string"
        ...
        "domain.Tenant": {
            ...
            "properties": {
                ...
                "plan": {
                    "$ref": "#/definitions/domain.TenantPlan"
                },
                "updatedAt": {
                    "type": "string"
                }
        ...
        "domain.TenantAssetConfig": {
            ...
            "properties": {
                ...
                "currency": {
                    "description": "overrides Asset.Currency",
                    "type": "string"
                },
                "details": {
                    "description": "overrides Asset.Details",
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "name": {
                    "description": "overrides Asset.Name",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "domain.Transaction": {
            ...
            "properties": {
                ...
                "amount_cents": {
                    "description": "Always in cents; positive value; type determines direction",
                    "type": "integer"
                },
                "category_id": {
                    "type": "string"
                ...
                "master_purchase_id": {
                    "description": "Empty for regular transactions; set in Phase 2",
                    "type": "string"
                },
                "occurred_at": {
                    "type": "string"
        ...
        "domain.UpsertTenantAssetConfigInput": {
            "type": "object",
            "required": [
                "asset_id"
            ],
        ...
        "handler.TokenResponse": {
            ...
            "properties": {
                "access_token": {
                    "description": "AccessToken is the PASETO access token.",
                    "type": "string"
                },
                "expires_at": {
                    "description": "ExpiresAt is the timestamp when the access token expires.",
                    "type": "string"
                },
                "refresh_token": {
                    "description": "RefreshToken is the PASETO refresh token.",
                    "type": "string"
                }
            }
        },
        ...
        "handler.UpdateTenantPlanRequest": {
            "type": "object",
            "required": [
                "plan"
            ],
